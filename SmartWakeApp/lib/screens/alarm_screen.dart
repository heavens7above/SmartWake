...
class _AlarmScreenState extends State<AlarmScreen> {
  ...
  Future<void> _setAlarm() async {
    ...
    var deadline = DateTime(now.year, now.month, now.day, _selectedTime!.hour,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('WAKE ALARM',
                  style: TextStyle(
                      color: AppTheme.textPrimary,
                      fontSize: 22,
                      fontWeight: FontWeight.w800,
                      letterSpacing: 2)),
              const Text('Set your target wake time',
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          if (_alarmStatus?.scheduled == true &&
                            ...
                            const Text('No alarm scheduled yet',
